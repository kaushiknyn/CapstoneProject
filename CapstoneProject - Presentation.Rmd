...
- The second input field is for entering the **Interest Rate**, the rate at which the bank will loan the money to the user
...
![Mortgage Calculator Interface](Mortgage_Calulator.png)